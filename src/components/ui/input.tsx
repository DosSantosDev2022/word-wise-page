...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, type, icon, variants = 'default', ...props }, ref) => {
		...
		return (
			<div
				className={twMerge(
					'flex h-16 w-full items-center gap-1 rounded-2xl border border-border bg-input p-3',
			...
			>
				...
				<input
					...
					className={twMerge(
						...
						'bg-transparent text-muted-foreground/70 placeholder:text-muted-foreground/70',
